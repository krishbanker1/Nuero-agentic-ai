...
SCENARIO_HANDLERS: Dict[ScenarioType, ScenarioHandler] = {
    ScenarioType.BUG_FIX: ScenarioHandler(
        ...
        model_fallback="openrouter/qwen/qwen3-coder:free",
    ...
    ScenarioType.NEW_FEATURE: ScenarioHandler(
        ...
        model_primary="openrouter/deepseek/deepseek-chat:free",
    ...
    ScenarioType.REFACTOR: ScenarioHandler(
        ...
        model_primary="openrouter/qwen/qwen3-coder:free",
        model_fallback="openrouter/deepseek/deepseek-v4-flash:free",
    ...
    ScenarioType.CODE_REVIEW: ScenarioHandler(
        ...
        model_primary="groq/llama-3.3-70b-versatile",
        model_fallback="groq/openai/gpt-oss-120b",
    ...
    ScenarioType.ENTERPRISE_APP: ScenarioHandler(
        ...
        model_primary="gemini-3.5-flash",
        model_fallback="openrouter/deepseek/deepseek-chat:free",
        confidence_threshold=0.6,
        max_retries=3,
        special_instructions=[
